-- Migration: Atualiza a RPC create_update_partner para incluir carteira_habilitacao
...
begin
  ...
  if v_pessoa_id is null then
    insert into public.pessoas (
      ...
      tipo_pessoa, fantasia, codigo_externo, contribuinte_icms, contato_tags, rg, carteira_habilitacao, celular, site
    )
    values (
      v_empresa_id,
